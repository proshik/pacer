...
- `/card 21097 1h38m48s` — карточка плана картинкой: дистанция, время, темп и раскладка по
...
3. Изменили страницу → `node scripts/checks/all.mjs`: проверки в headless Chrome (390 px, обе
   темы, оба языка, офлайн, ошибки у полей, сохранённые расчёты, слайдер дистанции).
4. Перед коммитом:
