...
Страницу это не покрывает: её проверяют пять скриптов на Node с headless Chrome —
`scripts/checks/language.mjs`, `offline.mjs`, `validation.mjs`, `saved-runs.mjs` и `slider.mjs`;
все разом —
