...
Страницу это не покрывает: её проверяют четыре скрипта на Node с headless Chrome —
`scripts/checks/language.mjs`, `offline.mjs`, `validation.mjs` и `saved-runs.mjs`; все разом —
